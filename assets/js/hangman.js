...
var _jpvillaisaza$hangman$Hangman$viewWord_ = function (model) {
	var base = function () {
		var _p0 = model.language;
		if (_p0.ctor === 'English') {
			return 'https://en.oxforddictionaries.com/definition/us/';
		} else {
			return 'http://dirae.es/palabras/';
		}
	}();
	return A2(
...
var _jpvillaisaza$hangman$Hangman$viewHistory = function (model) {
	return A2(
...
var _jpvillaisaza$hangman$Hangman$viewStatus = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _jpvillaisaza$hangman$Hangman$viewStats = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _jpvillaisaza$hangman$Hangman$viewStatus(model),
			_1: {
				ctor: '::',
				_0: _jpvillaisaza$hangman$Hangman$viewHistory(model),
				_1: {ctor: '[]'}
			}
		});
};
var _jpvillaisaza$hangman$Hangman$toLength = function (string) {
	var _p1 = _elm_lang$core$String$length(string);
	if (_p1 === 1) {
		return '1 letter';
	} else {
		return A2(
...
var _jpvillaisaza$hangman$Hangman$toStringL = function (model) {
	var fromLetter = function (_p2) {
		var _p3 = _p2;
		return _p3.guessed ? _p3.letter : _elm_lang$core$Native_Utils.chr('-');
	};
	return A3(
		_elm_lang$core$List$foldr,
...
var _jpvillaisaza$hangman$Hangman$viewLetters = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('letters'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									_jpvillaisaza$hangman$Hangman$toLength(model.word),
									')'))),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
...
var _jpvillaisaza$hangman$Hangman$viewHeader = function (model) {
	return A2(
...
var _jpvillaisaza$hangman$Hangman$viewGuesses = function (model) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('guesses'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Guesses: '),
			_1: A2(
				_elm_lang$core$List$map,
				show,
...
var _jpvillaisaza$hangman$Hangman$spanishDictionary = 'dict/spanish';
...
var _jpvillaisaza$hangman$Hangman$Spanish = {ctor: 'Spanish'};
var _jpvillaisaza$hangman$Hangman$English = {ctor: 'English'};
var _jpvillaisaza$hangman$Hangman$Won = {ctor: 'Won'};
var _jpvillaisaza$hangman$Hangman$Playing = function (a) {
	return {ctor: 'Playing', _0: a};
};
var _jpvillaisaza$hangman$Hangman$Lost = {ctor: 'Lost'};
	...
	function (guess, model) {
		var match = F2(
			function (guess, _p7) {
				...
				return {
					letter: _p9,
					guessed: A2(_jpvillaisaza$hangman$Hangman$checkLetter, guess, _p9) || _p8.guessed
				};
			});
		var letters = A2(
			_elm_lang$core$List$map,
			...
			if (_elm_lang$core$Native_Utils.eq(model.letters, letters)) {
				...
				if (_p10.ctor === 'Playing') {
					if (_p10._0 === 1) {
						...
						return _jpvillaisaza$hangman$Hangman$Playing(_p10._0 - 1);
					}
				} else {
					return model.status;
				}
				...
				if (A2(
					...
					letters)) {
					return _jpvillaisaza$hangman$Hangman$Won;
				} else {
					return model.status;
				}
			}
...
var _jpvillaisaza$hangman$Hangman$viewWord = function (model) {
	return A2(
		_elm_lang$html$Html$p,
		{
			ctor: '::',
		...
		(_elm_lang$core$Native_Utils.eq(model.status, _jpvillaisaza$hangman$Hangman$Lost) || _elm_lang$core$Native_Utils.eq(model.status, _jpvillaisaza$hangman$Hangman$Won)) ? {
			ctor: '::',
			_0: _jpvillaisaza$hangman$Hangman$viewWord_(model),
			_1: {ctor: '[]'}
		} : {ctor: '[]'});
};
...
var _jpvillaisaza$hangman$Hangman$viewLanguage = function (currentLanguage) {
	...
	var nextLanguage = _p11._0;
	var nextLanguageText = _p11._1;
...
var _jpvillaisaza$hangman$Hangman$viewRestart = function (model) {
	return A2(
		_elm_lang$html$Html$button,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('btn btn-default restart'),
			_1: {
				ctor: '::',
...
var _jpvillaisaza$hangman$Hangman$Dict = function (a) {
		...
		switch (_p13.ctor) {
			case 'Guess':
				return _jpvillaisaza$hangman$Hangman$isPlaying(model.status) ? {
					ctor: '_Tuple2',
					_0: A2(_jpvillaisaza$hangman$Hangman$guess, _p13._0, model),
			...
			case 'New':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							guesses: _elm_lang$core$Set$empty,
							letters: _jpvillaisaza$hangman$Hangman$toLetters(_p14),
							status: _jpvillaisaza$hangman$Hangman$Playing(5),
							word: _p14
						}),
					_1: _elm_lang$core$Platform_Cmd$none
			...
			default:
				...
				return {
					...
					_1: A2(
						_elm_lang$http$Http$send,
						_jpvillaisaza$hangman$Hangman$Dict,
						_jpvillaisaza$hangman$Hangman$getWords(_p15))
				};
		}
	});
var _jpvillaisaza$hangman$Hangman$Guess = function (a) {
...
var _jpvillaisaza$hangman$Hangman$viewKeyboard = function () {
	var sd = function (letter) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('btn btn-default key'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
...
var _jpvillaisaza$hangman$Hangman$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _jpvillaisaza$hangman$Hangman$viewHeader(model),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					...
					{
						ctor: '::',
						_0: _jpvillaisaza$hangman$Hangman$viewLetters(model),
						_1: {
							ctor: '::',
							_0: _jpvillaisaza$hangman$Hangman$viewStats(model),
							_1: {
								ctor: '::',
								_0: _jpvillaisaza$hangman$Hangman$viewWord(model),
								_1: {
									ctor: '::',
									_0: _jpvillaisaza$hangman$Hangman$viewGuesses(model),
									_1: {
										ctor: '::',
										_0: _jpvillaisaza$hangman$Hangman$viewRestart(model),
										_1: {
											ctor: '::',
...
var _jpvillaisaza$hangman$Hangman$main = _elm_lang$html$Html$program(
	{
		init: _jpvillaisaza$hangman$Hangman$init('hangman'),
		view: _jpvillaisaza$hangman$Hangman$view,
		update: _jpvillaisaza$hangman$Hangman$update,
		subscriptions: _jpvillaisaza$hangman$Hangman$subscriptions
	})();

var Elm = {};
Elm['Hangman'] = Elm['Hangman'] || {};
if (typeof _jpvillaisaza$hangman$Hangman$main !== 'undefined') {
    _jpvillaisaza$hangman$Hangman$main(Elm['Hangman'], 'Hangman', undefined);
}
